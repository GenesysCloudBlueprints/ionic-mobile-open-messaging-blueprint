...
endpoint you created.  You will POST to this URL: `<AWS API Gateway URL>/notification/integration/{integrationId}/user/{userId}`
...
For the Offers tab you can POST this message body to the `<AWS API Gateway URL>/notification/integration/{integrationId}/user/{userId}` URL:
```
{
    "type": "qrcode",
    "content": "SuperCoupon",
